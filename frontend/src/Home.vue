<template>
  ...
  <el-upload drag accept=".dat" :auto-upload="false" :show-file-list="false" :on-change="handleChange">
  ...
  <el-text size="large" style="margin: 10px 0;">完成度：{{data.Completion}}%</el-text>
